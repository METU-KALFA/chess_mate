...
frame = None
model = YOLO('/home/kovan-robot/ultralytics/100epochBest.pt')
model.names[0] = 'b'
model.names[1] = 'k'
model.names[2] = 'n'
model.names[3] = 'p'
...
class camera_XYZ:
    ...
    def find_board_coord(self, frame):
        ...
        img = cv2.adaptiveThreshold(img, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY_INV, 7, 5)
...
def capture_and_detect():
    ...
    if new_frame is not None:
        ...
        results = model(new_frame, conf=0.4)
