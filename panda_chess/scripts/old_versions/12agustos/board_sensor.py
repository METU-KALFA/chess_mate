...
class camera_XYZ:
    ...
    def calculate_xyz(self, pixel, new_depth_frame, new_frame):
        ...
        if intrinsics:
            depth_frame_data = None  # Replace this with your actual depth frame data
            depth_point_ = rs2.rs2_project_color_pixel_to_depth_pixel(
                depth_frame_data, depth_scale,
                0.11, 1.0,
                intrinsics, intrinsics, None, None, pixel)
